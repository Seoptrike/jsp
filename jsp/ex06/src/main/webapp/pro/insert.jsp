			...
			<div class="card-body">
				<form name="frm">
					<div class="input-group mb-2">
						<span class="input-group-text justify-content-center text-bg-secondary">교수번호</span>
						<input class="form-control" name="pcode" value="${code}" readonly>
					</div>
					
					<div class="input-group mb-2">
						<span class="input-group-text justify-content-center text-bg-secondary">교수이름</span>
						<input class="form-control" name="pname">
					</div>
					
					<div class="input-group mb-2">
						<span class="input-group-text justify-content-center text-bg-secondary">교수학과</span>
					...
					<div class="input-group mb-2">
						<span class="input-group-text justify-content-center text-bg-secondary">교수직급</span>
						<div class="form-check m-2">
							<input class="form-check-input" name="title" id="정교수" type="radio" value="정교수" checked>
					...
					<div class="input-group mb-2">
						<span class="input-group-text justify-content-center text-bg-secondary">교수급여</span>
						<input name="salary" class="form-control" type="number" value="0" step="1000000">
					</div>
					
					<div class="input-group mb-2">
						<span class="input-group-text justify-content-center text-bg-secondary">임용일자</span>
