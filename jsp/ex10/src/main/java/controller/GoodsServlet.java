...
@WebServlet(value= {"/goods/search","/goods/search.json","/goods/insert","/goods/list","/goods/list.json","/goods/delete","/goods/total","/goods/read"})
public class GoodsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "/goods/read":
			...
			request.setAttribute("goods", dao.read(gid));
